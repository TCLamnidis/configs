...
apply_theme() {
    ...
    pane_active_border_fg=colour10 # blue
    ...
    window_status_bg_matching=colour242
    ...
    window_status_current_bg=colour89 # blue
    window_status_current_bg_matching=colour89
    window_status_current_format="#[fg=$window_status_bg_matching,bg=$window_status_current_bg]$left_separator_black#[fg=$window_status_current_fg,bg=$window_status_current_bg,bold] #I $left_separator #W #[fg=$window_status_current_bg_matching,bg=$status_bg,nobold]$left_separator_black"
    ...
    window_status_last_fg=colour7 # blue
